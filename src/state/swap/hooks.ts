...
const BAD_RECIPIENT_ADDRESSES: { [chainId: string]: { [address: string]: true } } = {
  [ChainId.LACCHAIN]: {
    [FACTORY_ADDRESS[ChainId.LACCHAIN]]: true,
    [ROUTER_ADDRESS[ChainId.LACCHAIN]]: true,
  },
  [ChainId.LACCHAIN_TESTNET]: {
    [FACTORY_ADDRESS[ChainId.LACCHAIN_TESTNET]]: true,
    [ROUTER_ADDRESS[ChainId.LACCHAIN_TESTNET]]: true,
  },
}
...
export function queryParametersToSwapState(parsedQs: ParsedQs, chainId: ChainId = ChainId.LACCHAIN): SwapState {
