...
export default function Stake() {
  ...
  const boneBalance = useTokenBalance(account ?? undefined, MATE[chainId])
  const xBoneBalance = useTokenBalance(account ?? undefined, XMATE[chainId])
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as MATE
                                proportional to your share of the MeatBone. When your MATE is staked into the MeatBone, you receive
                                xMATE in return.
          ...
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xbone-sign.png" alt="xMATE sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
              ...
              <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  {(xBoneBalance && xSushiPerSushi) ?
                    (<div className="mt-3">
                      ~ {xBoneBalance.multiply(Math.round(xSushiPerSushi * 1e8)).divide(1e8).toSignificant(8)} MATE
                    </div>) : (<></>)
                  }
                </div>
