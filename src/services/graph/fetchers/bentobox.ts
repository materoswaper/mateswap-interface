...
export const BENTOBOX = {
  [ChainId.LACCHAIN]: 'boneswap/bentobox',
}
...
export const getKashiPairs = async (chainId = ChainId.LACCHAIN, variables = undefined) => {
...
export const getUserKashiPairs = async (chainId = ChainId.LACCHAIN, variables) => {
...
export const getBentoUserTokens = async (chainId = ChainId.LACCHAIN, variables) => {
